    ...
    <>
      ...
      <BrowserRouter>
        <Routes>
            ...
            <Route path="/Forum/:name" element={<ForumPage />} /> { /* : is used when the URL is a variable. we might be able to make a set up where each forum has its own URL (and thats kinda what im doing right now)- but then we have to restrict forum names to be one of one. */ }
        </Routes>
      </BrowserRouter>
    </>
  )
